    ...
    DomainKnowledgeGraph(
        ...
        entities=[
            DomainKnowledgeEntity(
                ...
                name="Harness 工程",
                entity_type="concept",
                aliases=["Agent Harness", "模型之外的工程层", "执行支架"],
                summary=(
            ...
            DomainKnowledgeEntity(
                ...
                name="工具调用循环",
                entity_type="workflow",
                aliases=["ReAct 循环", "Action-Observation loop", "工具执行循环"],
                summary=(
            ...
            DomainKnowledgeEntity(
                ...
                name="GraphRAG",
                entity_type="concept",
                aliases=["知识图谱检索", "实体关系图谱", "Graph-based RAG"],
                summary=(
    ...
    DomainKnowledgeGraph(
        ...
        entities=[
            DomainKnowledgeEntity(
                ...
                name="多模态医学影像模型",
                entity_type="concept",
                aliases=["医学影像大模型", "影像基础模型", "vision-language medical model"],
